...
return(
    <div className={`shadow-md relative flex flex-col items-center  rounded-md bg-white dark:bg-slate-800 p-6 ${className}`}>
        <b className="absolute right-10 text-purple-700 bg-purple-300 p-2 rounded-md"><FaEllipsisH /></b>
        {children}
        ...
        <div className="flex items-center justify-between w-[90%] mx-auto my-3">
            ...
            <Button text-centerutton text={(<b className="flex items-center gap-2 text-center justify-center"><BsEnvelope /> Chat</b>)} className="bg-red-400 w-1/2 text-center" borderRadius="7px"/>
        </div>
    </div>
)
}
